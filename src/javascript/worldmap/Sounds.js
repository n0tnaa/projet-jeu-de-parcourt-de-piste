  ...
  setEngine() {
    ...
    this.time.on("tick", () => {
      ...
      this.engine.sound.volume(
        (this.engine.volume.min + volumeAmplitude * this.engine.progress) *
    ...
    if (this.debug) {
      ...
      folder
        .add(this.engine, "progressEasingUp")
        .step(0.001)
        .min(0)
        .max(1)
        .name("progressEasingUp");
      folder
        .add(this.engine, "progressEasingDown")
        .step(0.001)
        .min(0)
        .max(1)
        .name("progressEasingDown");
      folder
        .add(this.engine.rate, "min")
        .step(0.001)
        .min(0)
        .max(4)
        .name("rateMin");
      folder
        .add(this.engine.rate, "max")
        .step(0.001)
        .min(0)
        .max(4)
        .name("rateMax");
      folder
        .add(this.engine, "speedMultiplier")
        .step(0.01)
        .min(0)
        .max(5)
        .name("speedMultiplier");
      folder
        .add(this.engine, "accelerationMultiplier")
        .step(0.01)
        .min(0)
        .max(100)
        .name("accelerationMultiplier");
      folder
        .add(this.engine, "progress")
        .step(0.01)
        .min(0)
        .max(1)
        .name("progress")
