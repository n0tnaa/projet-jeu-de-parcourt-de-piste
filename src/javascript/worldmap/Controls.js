...
export default class Controls extends EventEmitter {
  ...
  setTouch() {
    ...
    this.touch.boost.events.touchend = (_event) => {
      const touches = [..._event.changedTouches];
      const touch = touches.find(
        (_touch) => _touch.identifier === this.touch.boost.touchIdentifier
      );
    ...
    this.touch.forward.events.touchend = (_event) => {
      const touches = [..._event.changedTouches];
      const touch = touches.find(
        (_touch) => _touch.identifier === this.touch.forward.touchIdentifier
      );
    ...
    this.touch.brake.events.touchend = (_event) => {
      const touches = [..._event.changedTouches];
      const touch = touches.find(
        (_touch) => _touch.identifier === this.touch.brake.touchIdentifier
      );
    ...
    this.touch.backward.events.touchend = (_event) => {
      const touches = [..._event.changedTouches];
      const touch = touches.find(
        (_touch) => _touch.identifier === this.touch.backward.touchIdentifier
      );
