      ...
      for (const _distinction of this.distinctions) {
        ...
        switch (_distinction.type) {
          case "awwwards":
            ...
            collision = this.resources.items
          ...
          case "fwa":
            ...
            collision = this.resources.items.projectsDistinctionsFWACollision
              .scene;
            shadowSizeX = 2;
            shadowSizeY = 1;
            break;
          ...
          case "cssda":
            ...
            collision = this.resources.items.projectsDistinctionsCSSDACollision
              .scene;
            shadowSizeX = 1.2;
            shadowSizeY = 1.2;
            break;
